...
public class server_frame extends javax.swing.JFrame 
{
   ...
   public class ClientHandler implements Runnable //note	
   {
...
//                System.out.println("client:"+client);
    ...
    public class ServerStart implements Runnable //not 
    {
        @Override
        public void run() 
        {
            clientOutputStreams = new ArrayList(); // tạo 1 list user được gửi tới server
            users = new ArrayList();  // tạo 1 list user

            try 
            {
                ServerSocket serverSock = new ServerSocket(2222); // tạo port 2222
...
//                   System.out.println("T3");
	...
	Iterator it = clientOutputStreams.iterator(); //tách mảng thành các đối tượng
		...
		ta_chat.append("Sending: " + message + "\n");
                writer.flush();
                ta_chat.setCaretPosition(ta_chat.getDocument().getLength());// set giao diện
